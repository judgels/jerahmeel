...
public final class ChapterScoreCacheUtils {
    ...
    static ChapterScoreCacheUtils getInstance() {
        if (instance == null) {
    ...
    double getUserTotalScoreFromCourseChapterModels(String userJid, String courseJid, List<CourseChapterModel> courseChapterModels, Map<String, List<ChapterProblemModel>> mapChapterJidToChapterProblemModels) {
    ...
    double getUserTotalScoreFromCourseChapterModelsWithoutCache(String userJid, List<CourseChapterModel> courseChapterModels, Map<String, List<ChapterProblemModel>> mapChapterJidToChapterProblemModels) {
        double totalScore = 0;
    ...
    double getUserTotalScoreFromChapterProblemModels(String userJid, String chapterJid, List<ChapterProblemModel> chapterProblemModels) {
    ...
    double getUserTotalScoreFromChapterProblemModelsWithoutCache(String userJid, List<ChapterProblemModel> chapterProblemModels) {
        double totalScore = 0;
    ...
    double getUserMaxScoreFromChapterProblemModel(String userJid, ChapterProblemModel chapterProblemModel) {
    ...
    void updateChapterAndCourseScoreCache(String userJid, String chapterJid, double deltaScore) {
        if (containerScoreCacheDao.existsByUserJidAndContainerJid(userJid, chapterJid)) {
            ContainerScoreCacheModel containerScoreCacheModel = containerScoreCacheDao.getByUserJidAndContainerJid(userJid, chapterJid);
    ...
    void updateCourseScoreCache(String userJid, String courseJid, double deltaScore, Map<String, List<CourseChapterModel>> mapCourseJidToCourseChapterModels, Map<String, List<ChapterProblemModel>> mapChapterJidToChapterProblemModels) {
        if (containerScoreCacheDao.existsByUserJidAndContainerJid(userJid, courseJid)) {
            ContainerScoreCacheModel containerScoreCacheModel = containerScoreCacheDao.getByUserJidAndContainerJid(userJid, courseJid);
            containerScoreCacheModel.score = containerScoreCacheModel.score + deltaScore;
