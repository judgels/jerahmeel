...
public final class ChapterProgressCacheUtils {
    ...
    static ChapterProgressCacheUtils getInstance() {
        if (instance == null) {
    ...
    void updateChapterProblemProgressWithBundleSubmissions(String userJid, String containerJid, String problemJid, List<BundleSubmission> bundleSubmissions) {
    ...
    void updateChapterProblemProgressWithProgrammingSubmissions(String userJid, String containerJid, String problemJid, List<ProgrammingSubmission> programmingSubmissions) {
        boolean completed = false;
