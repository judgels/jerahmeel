...
public final class ArchiveServiceImpl implements ArchiveService {
    ...
    public List<ArchiveWithScore> getChildArchivesWithScore(String parentJid, String userJid) {
        ...
        for (Archive archive : directSubArchives) {
            double totalScore;
            if (containerScoreCacheDao.existsByUserJidAndContainerJid(userJid, archive.getJid())) {
                ContainerScoreCacheModel containerScoreCacheModel = containerScoreCacheDao.getByUserJidAndContainerJid(userJid, archive.getJid());
                ...
                while (!subArchivesJidStack.empty()) {
                    ...
                    totalScore += ArchiveServiceUtils.getArchiveScore(containerScoreCacheDao, containerProblemScoreCacheDao, archiveDao, problemSetDao, problemSetProblemDao, bundleSubmissionDao, bundleGradingDao, programmingSubmissionDao, programmingGradingDao, userJid, subArchiveJid);
