...
public final class CourseSessionJedisHibernateDao extends AbstractJedisHibernateDao<Long, CourseSessionModel> implements CourseSessionDao {

    @Inject
    public CourseSessionJedisHibernateDao(JedisPool jedisPool) {
        super(jedisPool, CourseSessionModel.class);
    }
