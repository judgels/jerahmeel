...
import org.iatoki.judgels.jerahmeel.forms.ChapterUpsertForm;
import org.iatoki.judgels.jerahmeel.services.ChapterService;
import org.iatoki.judgels.jerahmeel.services.UserItemService;
import org.iatoki.judgels.jerahmeel.views.html.chapter.createChapterView;
import org.iatoki.judgels.jerahmeel.views.html.chapter.editChapterGeneralView;
import org.iatoki.judgels.jerahmeel.views.html.chapter.listChaptersView;
...
public final class ChapterController extends AbstractJudgelsController {
    ...
    public Result jumpToLessons(long chapterId) {
        return redirect(routes.ChapterLessonController.viewChapterLessons(chapterId));
    }

    public Result jumpToProblems(long chapterId) {
        return redirect(routes.ChapterProblemController.viewChapterProblems(chapterId));
    }

    public Result jumpToSubmissions(long chapterId) {
        return redirect(routes.ChapterController.jumpToProgrammingSubmissions(chapterId));
    }
