...
import org.iatoki.judgels.jerahmeel.forms.CourseChapterAddForm;
import org.iatoki.judgels.jerahmeel.forms.CourseChapterEditForm;
...
import org.iatoki.judgels.jerahmeel.views.html.course.chapter.editCourseChapterView;
import org.iatoki.judgels.jerahmeel.views.html.course.chapter.listAddCourseChaptersView;
...
public final class CourseChapterController extends AbstractJudgelsController {
    ...
    private void appendBreadcrumbsLayout(LazyHtml content, Course course, InternalLink... lastLinks) {
        ...
        breadcrumbsBuilder.add(new InternalLink(Messages.get("course.chapters"), routes.CourseController.jumpToChapters(course.getId())));
