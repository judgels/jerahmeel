...
import org.iatoki.judgels.jerahmeel.forms.ChapterLessonAddForm;
import org.iatoki.judgels.jerahmeel.forms.ChapterLessonEditForm;
...
import org.iatoki.judgels.jerahmeel.views.html.chapter.lesson.addChapterLessonView;
import org.iatoki.judgels.jerahmeel.views.html.chapter.lesson.editChapterLessonView;
import org.iatoki.judgels.jerahmeel.views.html.chapter.lesson.listChapterLessonsView;
import org.iatoki.judgels.jerahmeel.views.html.chapter.lesson.viewLessonView;
...
public final class ChapterLessonController extends AbstractJudgelsController {
    ...
    private void appendBreadcrumbsLayout(LazyHtml content, Chapter chapter, InternalLink... lastLinks) {
        ...
        breadcrumbsBuilder.add(new InternalLink(Messages.get("chapter.lessons"), routes.ChapterController.jumpToLessons(chapter.getId())));
